(() => {
      ...
      exports.DD = {
        ...
        _drag(evt) {
          ...
          exports.DD._dragElements.forEach((elem, key) => {
            const { node } = elem;
            const stage2 = node.getStage();
            stage2.setPointersPositions(evt);
            if (elem.pointerId === void 0) {
              elem.pointerId = Util_1.Util._getFirstPointerId(evt);
            }
            const pos = stage2._changedPointerPositions.find((pos2) => pos2.id === elem.pointerId);
            if (!pos) {
              return;
            }
            if (elem.dragStatus !== "dragging") {
    ...
    "node_modules/konva/lib/Node.js"(exports) {
      ...
      var Node = class _Node {
        ...
        shouldDrawHit(top, skipDragCheck = false) {
          ...
          DragAndDrop_1.DD._dragElements.forEach((elem) => {
            if (elem.dragStatus !== "dragging") {
              ...
              layerUnderDrag = true;
            } else if (elem.node.getLayer() === layer2) {
              layerUnderDrag = true;
            }
          });
        ...
        getAbsoluteZIndex() {
          ...
          const stage2 = this.getStage();
          if (that.nodeType !== UPPER_STAGE && stage2) {
            addChildren(stage2.getChildren());
          }
          return index;
        }
        getDepth() {
        ...
        _toKonvaCanvas(config) {
          ...
          const stage2 = this.getStage(), x = config.x !== void 0 ? config.x : Math.floor(box.x), y = config.y !== void 0 ? config.y : Math.floor(box.y), pixelRatio = config.pixelRatio || 1, canvas = new Canvas_1.SceneCanvas({
            width: config.width || Math.ceil(box.width) || (stage2 ? stage2.width() : 0),
            height: config.height || Math.ceil(box.height) || (stage2 ? stage2.height() : 0),
            pixelRatio
        ...
        _createDragElement(evt) {
          ...
          const pos = stage2._getPointerById(pointerId) || stage2._changedPointerPositions[0] || ap;
        ...
        isClientRectOnScreen(margin = { x: 0, y: 0 }) {
          ...
          const screenRect = {
            x: -margin.x,
            y: -margin.y,
            width: stage2.width() + 2 * margin.x,
            height: stage2.height() + 2 * margin.y
          };
    ...
    "node_modules/konva/lib/Container.js"(exports) {
      ...
      var Container = class extends Node_1.Node {
        ...
        drawScene(can, top, bufferCanvas) {
          const layer2 = this.getLayer(), canvas = can || layer2 && layer2.getCanvas(), context = canvas && canvas.getContext(), cachedCanvas = this._getCanvasCache(), cachedSceneCanvas = cachedCanvas && cachedCanvas.scene;
        ...
        drawHit(can, top) {
          ...
          const layer2 = this.getLayer(), canvas = can || layer2 && layer2.hitCanvas, context = canvas && canvas.getContext(), cachedCanvas = this._getCanvasCache(), cachedHitCanvas = cachedCanvas && cachedCanvas.hit;
          if (cachedHitCanvas) {
            context.save();
            const m = this.getAbsoluteTransform(top).getMatrix();
            context.transform(m[0], m[1], m[2], m[3], m[4], m[5]);
      ...
      var Stage = class extends Container_1.Container {
        ...
        _toKonvaCanvas(config) {
          ...
          layers.forEach(function(layer2) {
            ...
            const layerCanvas = layer2._toKonvaCanvas(config);
        ...
        add(layer2, ...rest) {
          ...
          layer2.setSize({ width: this.width(), height: this.height() });
          layer2.draw();
          if (Global_1.Konva.isBrowser) {
            this.content.appendChild(layer2.canvas._canvas);
          }
          return this;
        }
        getParent() {
        ...
        batchDraw() {
          this.getChildren().forEach(function(layer2) {
            layer2.batchDraw();
          });
          return this;
        }
    ...
    "node_modules/konva/lib/Shape.js"(exports) {
      ...
      var Shape = class extends Node_1.Node {
        ...
        intersects(point) {
          ...
          const bufferHitCanvas = stage2.bufferHitCanvas;
        ...
        drawScene(can, top, bufferCanvas) {
          const layer2 = this.getLayer();
          let canvas = can || layer2.getCanvas(), context = canvas.getContext(), cachedCanvas = this._getCanvasCache(), drawFunc = this.getSceneFunc(), hasShadow = this.hasShadow(), stage2, bufferContext;
          ...
          if (this._useBufferCanvas() && !skipBuffer) {
            stage2 = this.getStage();
            const bc = bufferCanvas || stage2.bufferCanvas;
        ...
        drawHit(can, top, skipDragCheck = false) {
          ...
          const layer2 = this.getLayer(), canvas = can || layer2.hitCanvas, context = canvas && canvas.getContext(), drawFunc = this.hitFunc() || this.sceneFunc(), cachedCanvas = this._getCanvasCache(), cachedHitCanvas = cachedCanvas && cachedCanvas.hit;
          if (!this.colorKey) {
    ...
    "node_modules/konva/lib/Layer.js"(exports) {
      ...
      var Layer = class extends Container_1.Container {
        ...
        setZIndex(index) {
          ...
          const stage2 = this.getStage();
          if (stage2 && stage2.content) {
            stage2.content.removeChild(this.getNativeCanvasElement());
            if (index < stage2.children.length - 1) {
              stage2.content.insertBefore(this.getNativeCanvasElement(), stage2.children[index + 1].getCanvas()._canvas);
            } else {
              stage2.content.appendChild(this.getNativeCanvasElement());
            }
          }
          return this;
        }
        ...
        moveUp() {
          ...
          stage2.content.removeChild(this.getNativeCanvasElement());
          if (this.index < stage2.children.length - 1) {
            stage2.content.insertBefore(this.getNativeCanvasElement(), stage2.children[this.index + 1].getCanvas()._canvas);
          } else {
            stage2.content.appendChild(this.getNativeCanvasElement());
          }
          return true;
        ...
        moveDown() {
          if (Node_1.Node.prototype.moveDown.call(this)) {
            const stage2 = this.getStage();
            if (stage2) {
              const children = stage2.children;
              if (stage2.content) {
                stage2.content.removeChild(this.getNativeCanvasElement());
                stage2.content.insertBefore(this.getNativeCanvasElement(), children[this.index + 1].getCanvas()._canvas);
              }
            }
            return true;
          }
        ...
        moveToBottom() {
          if (Node_1.Node.prototype.moveToBottom.call(this)) {
            ...
            if (stage2) {
              ...
              if (stage2.content) {
                stage2.content.removeChild(this.getNativeCanvasElement());
                stage2.content.insertBefore(this.getNativeCanvasElement(), children[1].getCanvas()._canvas);
              }
            }
            return true;
          }
        ...
        drawScene(can, top) {
          const layer2 = this.getLayer(), canvas = can || layer2 && layer2.getCanvas();
        ...
        drawHit(can, top) {
          const layer2 = this.getLayer(), canvas = can || layer2 && layer2.hitCanvas;
          if (layer2 && layer2.clearBeforeDraw()) {
            layer2.getHitCanvas().getContext().clear();
          }
        ...
        static _runFrames() {
          ...
          for (let n = 0; n < animations.length; n++) {
            ...
            for (let i = 0; i < layersLen; i++) {
              ...
              if (layer2._id !== void 0) {
                layerHash[layer2._id] = layer2;
              }
            }
          }
    ...
    "node_modules/konva/lib/shapes/Transformer.js"(exports) {
      ...
      var Transformer = class extends Group_1.Group {
        ...
        _handleMouseMove(e) {
          ...
          const stage2 = anchorNode.getStage();
          stage2.setPointersPositions(e);
          const pp = stage2.getPointerPosition();
          let newNodePos = {
  ...
  var stage = new import_konva.default.Stage({
    container: "container",
